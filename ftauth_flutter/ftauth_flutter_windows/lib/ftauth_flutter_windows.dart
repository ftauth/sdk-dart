...
class _WindowsAuthorizer extends AuthorizerImpl {
  _WindowsAuthorizer(
    Config config, {
...
class FTAuthFlutterWindows extends FTAuthPlatform {
  /// Registers this class as the default instance of [FTAuthPlatform]
  static void registerWith() {
    FTAuthPlatform.instance = FTAuthFlutterWindows();
  }
